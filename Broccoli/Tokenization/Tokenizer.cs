    ...
    public class Tokenizer {
        ...
        public Tokenizer(string source) {
            ...
            RootSExps = SExpression.GetSexpRangesList(tokens)
                .Select(t => new SExpression(tokens.GetRange(t.Item1, t.Item2 - t.Item1 + 1)))
                .ToArray();
        }
            ...
            try {
                ...
                switch (c = NextChar()) {
                    ...
                    case char d when char.IsDigit(c):
                        ...
                        return new Token(num.Contains('.') ? TokenType.Float : TokenType.Integer,
                            d + num, _row, _column);
                    // Misc
        ...
        private string NextIdentifier() {
            ...
            if (!IsValidIdentifier(result))
                throw new Exception(
                    $"Invalid identifier at {_row}:{_column}"); // TODO: Custom exception class?
