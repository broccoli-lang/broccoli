...
namespace Broccoli {
    ...
    internal static class TypeExtensions {
        ...
        public static PropertyInfo TryGetProperty(this Type type, string name) =>
            type.GetProperty(name) ?? throw new Exception($"Type '{type.FullName}' has no field '{name}'");
        ...
        public static FieldInfo TryGetField(this Type type, string name) =>
            type.GetField(name) ?? throw new Exception($"Type '{type.FullName}' has no field '{name}'");
    }
